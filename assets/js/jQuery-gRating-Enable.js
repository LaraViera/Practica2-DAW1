...
(function($) {
  ...
  $.fn.grating1 = function(options) {
    /* Default plugin options */
    $.fn.grating1.defaultOptions = {
      ...
      clicklimit: -1,//Whether to limit the number of clicks or not, a value of 0 enables no limit
    ...
    function init()
    {
      ...
      base.options = $.extend(true, {}, $.fn.grating1.defaultOptions, options);
      base.$elems.each(function(key, value)
      {
        var _this = this;
        _this.$this = $(this);
